	        ...
	        <div class="columns-1 grid">
		        <div class="column">
			        <div class="obox-help-buttons">
				        <a target="blank" href="http://kb.oboxsites.com/wp-content/uploads/2013/01/motionpicture-demo-content.zip" class="demo-content"><span>Demo Content</span></a>
				        <a target="blank" href="http://kb.oboxsites.com/themedoc-category/motion-picture-docs/" class="documentation" target="_blank"><span>Documentation</span></a>
         ...
         ?>
            ...
            <div class="section">
                ...
                <ul class="columns-4 action-list">
                    ...
                    <li class="column"><a href="<?php echo admin_url('post-new.php?post_type=page'); ?>" class="to-do" target="blank">Create the Pages OR</a></li>
                    <li class="column"><a href="http://kb.oboxsites.com/wp-content/uploads/2013/01/motionpicture-demo-content.zip" class="to-do" target="blank">Import Demo Content</a></li>
